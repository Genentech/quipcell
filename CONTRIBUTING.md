...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `quipcell`'s files. While this mechanism can
...
[repository]: https://github.com/<USERNAME>/quipcell
[issue tracker]: https://github.com/<USERNAME>/quipcell/issues
